...
public class EmailService implements IEmailService {
    ...
    public String sendEmail(Email email)throws BookStoreCustomException{
        final String fromEmail="kulkarnimaitreyi0@gmail.com";
        final String fromPassword="jklibdgurhmbvthd";
        ...
        throw new BookStoreCustomException("ERROR:Couldn't send mail!");
    }
    @Override
    public String getLink(String token){
        return "http://localhost:8088/userRegistration/verify/" + token;
    }
}